...
VALUES
  ...
  ('contact', '{"email": "halo@ribcenter.id", "whatsapp": "081155008899", "address": "Gedung RIB CENTER, Jl. Ahmad Yani No. 88, Samarinda, Kalimantan Timur 75117"}'::jsonb, true),
...
VALUES
  ...
  ('profile_summary', 'Sekilas Profil', true, 2, '{"summary": "Komitmen penuh untuk menghadirkan kerja nyata, mendengar setiap aspirasi warga, serta menjaga keterbukaan informasi publik secara berkelanjutan demi kemajuan Kalimantan Timur."}'::jsonb),
...
VALUES (
  ...
  '/logo.png',
  'Rahmat Ichwan Bahtiar adalah tokoh masyarakat dan praktisi kebijakan publik yang berfokus pada penguatan tata kelola pemerintahan yang partisipatif, pemberdayaan ekonomi masyarakat bawah, serta pemerataan akses pendidikan dan kesehatan di Kalimantan Timur.
...
Salah satu fitur unggulan yang disediakan adalah kanal Aspirasi Warga. Melalui fitur ini, setiap pengaduan, kritik, maupun permohonan fasilitas publik akan tercatat secara sistematis dan dapat dipantau status tindak lanjutnya mulai dari tahap verifikasi hingga penyelesaian di lapangan.', 'PUBLISHED', true, now(), 'https://images.unsplash.com/photo-1541872703-74c5e44368f9?auto=format&fit=crop&w=1200&q=80'),
  ('30000000-0000-0000-0000-000000000002', 'Tinjau Sentra Pertanian Palaran, Rahmat Dorong Perluasan Infrastruktur Irigasi', 'tinjau-sentra-pertanian-dorong-infrastruktur-irigasi', 'BERITA', 'Pembangunan Daerah', 'Tim Media RIB CENTER', 'Kunjungan kerja lapangan dilakukan guna memetakan kebutuhan mendesak para petani terkait pasokan air dan kestabilan distribusi pupuk di musim tanam mendatang.', 'PALARAN — Rahmat Ichwan Bahtiar bersama jajaran tim RIB CENTER melakukan peninjauan langsung ke area persawahan dan perkebunan hortikultura di wilayah Palaran, Samarinda.
...
Rahmat Ichwan Bahtiar menegaskan bahwa potensi anak muda daerah sangat luar biasa jika diberikan wadah dan fasilitas yang memadai. Melalui sinergi antara kreativitas generasi muda dan ketekunan pelaku UMKM, produk-produk lokal Kalimantan Timur diyakini mampu bersaing di kancah nasional.', 'PUBLISHED', false, now(), 'https://images.unsplash.com/photo-1516253593875-bd7ba052fbc5?auto=format&fit=crop&w=1200&q=80'),
...
Melalui RIB CENTER, saya berkomitmen untuk mempraktikkan standar akuntabilitas ini secara konsisten. Mari bersama-sama membudayakan keterbukaan demi pemerintahan daerah yang bersih, berwibawa, dan benar-benar berpihak pada rakyat.', 'PUBLISHED', true, now(), 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80'),
  ('30000000-0000-0000-0000-000000000005', 'Peta Jalan Peningkatan Mutu Pendidikan Vokasi Menghadapi Dinamika IKN', 'peta-jalan-peningkatan-pendidikan-vokasi-ikn', 'GAGASAN', 'Pendidikan', 'Rahmat Ichwan Bahtiar', 'Menyikapi pemindahan Ibu Kota Nusantara, anak-anak daerah tidak boleh sekadar menjadi penonton di rumah sendiri. Revitalisasi SMK dan pelatihan vokasi adalah harga mati.', 'Pembangunan Ibu Kota Nusantara (IKN) di Kalimantan Timur membuka gelombang peluang ekonomi dan ketenagakerjaan yang masif. Namun, pertanyaan mendasar yang harus kita jawab bersama adalah: apakah tenaga kerja lokal kita sudah dipersiapkan dengan kompetensi yang sesuai?
...
Kedua, kemitraan wajib (link and match) antara kontraktor besar di IKN dengan balai latihan kerja lokal untuk transfer pengetahuan dan teknologi.
...
Ketiga, beasiswa afirmasi ke perguruan tinggi unggulan bagi siswa berprestasi di pelosok daerah agar lahir perencana kota dan insinyur unggul dari putra-putri daerah sendiri.', 'PUBLISHED', false, now(), 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1200&q=80'),
  ('30000000-0000-0000-0000-000000000006', 'Menjaga Kedaulatan Nelayan Tradisional dan Konservasi Pesisir Daerah', 'menjaga-kedaulatan-nelayan-dan-konservasi-pesisir', 'GAGASAN', 'Kelautan & Lingkungan', 'Rahmat Ichwan Bahtiar', 'Pemberdayaan nelayan tangkap pesisir harus berjalan seiring dengan penjagaan kelestarian ekosistem mangrove dan terumbu karang.', 'Pesisir Kalimantan Timur kaya akan potensi perikanan laut dan tambak. Namun, nelayan tradisional kerap terjepit oleh tingginya biaya operasional bahan bakar perahu dan minimnya fasilitas cold storage (rantai pendingin) di Tempat Pelelangan Ikan (TPI).
...
VALUES
  ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1541888946425-d0fbb18086f6?w=800&q=80', 'IMAGE', 'Dialog Hangat Bersama Tokoh Masyarakat Palaran', 'Rahmat Ichwan Bahtiar berdiskusi bersama warga', 'Diskusi tatap muka mendengarkan aspirasi tata ruang desa.'),
  ...
  ('50000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1516253593875-bd7ba052fbc5?w=800&q=80', 'IMAGE', 'Sesi Pembekalan Fotografi Produk Ponsel untuk UMKM', 'Pelatihan foto produk pelaku usaha mikro', 'Peserta mempraktikkan pengambilan foto katalog promosi.'),
