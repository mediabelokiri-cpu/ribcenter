...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="p-6 rounded-xl bg-white border border-neutral-200 shadow-xs">
        <span className="inline-block px-2.5 py-1 text-xs font-semibold tracking-wide uppercase rounded bg-[#AF191A]/10 text-[#AF191A] mb-2">
          CMS &amp; Platform Foundation
        </span>
        <h1 className="text-2xl font-bold tracking-tight text-[#191919]">Dashboard Ringkasan</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-xl bg-white border border-neutral-200 shadow-xs">
          ...
          <div className="text-3xl font-extrabold mt-2 text-[#191919]">
        ...
        <div className="p-5 rounded-xl bg-white border border-neutral-200 shadow-xs">
          <div className="flex justify-between items-start">
            ...
            {stats.counts.pendingAspirations > 0 && (
              <span className="px-2 py-0.5 text-[10px] font-bold rounded-full bg-[#FFCC00]/25 text-[#191919]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-xl bg-white border border-neutral-200 shadow-xs">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-base font-bold text-[#191919]">Aspirasi Masuk Terbaru</h2>
            <Link
              href="/admin/aspirasi"
          ...
          <div className="space-y-3">
            {stats.latestAspirations.length === 0 ? (
              ...
              stats.latestAspirations.map((asp) => (
                <div
                  key={asp.id}
                  className="p-3 rounded-lg border border-neutral-100 bg-neutral-50/70 text-xs"
                >
                  <div className="flex justify-between items-start">
        ...
        <div className="p-6 rounded-xl bg-white border border-neutral-200 shadow-xs">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-base font-bold text-[#191919]">Rekam Kerja Terbaru</h2>
            <Link
              ...
              stats.latestActivities.map((act) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className="px-2 py-0.5 text-[10px] font-mono rounded bg-neutral-200 text-neutral-800">
                      {act.type}
                    </span>
                  </div>
