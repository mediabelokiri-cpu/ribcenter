      ...
      {isAdding && (
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1">Nama Organisasi *</label>
              <input
            ...
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1">Peran / Jabatan *</label>
              <input
                name="role"
                type="text"
                required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1">Periode Mulai *</label>
              <input
                name="period_start"
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1">Periode Selesai</label>
              <input
                name="period_end"
                type="text"
          ...
          <div>
            <label className="block text-xs font-medium text-neutral-700 mb-1">Deskripsi &amp; Kontribusi</label>
            <textarea
              name="description"
              rows={3}
